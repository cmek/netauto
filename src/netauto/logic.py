...
class LagManager:
    ...
    def create_lag(self, lag_name: str, member_ports: List[str], lacp_mode: str = "active") -> List[str]:
        """
        ...
        for port in member_ports:
            ...
            if current_interfaces[port].lag_member_of:
                raise ValueError(f"Port {port} is already a member of {current_interfaces[port].lag_member_of}")
